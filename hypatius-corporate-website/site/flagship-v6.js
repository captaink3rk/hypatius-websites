...
(function () {
  ...
  var HEADLINES = {
    clarity: {
      ...
      sub: 'HYPATIUS, LLC builds the <b>software operating layer for contested-domain defense</b> \u2014 space wargaming and BMC3I, capture decision intelligence, and program execution. One company. Three platforms, each with its own name, its own site and its own accent, composing into one picture.'
    },
    superiority: {
