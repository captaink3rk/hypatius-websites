/* verification/verify-site.mjs · alidade.us v3 website harness
   Carries the focus-timing fix from the STARCHITECT harness: getComputedStyle
   immediately after a synthetic Tab returns a stale outline-width of 0 in this
   headless build, which produced eighteen confident false failures there.
...
const SCREENS=[
  ['home', '../alidade-website/index.html'],
];
